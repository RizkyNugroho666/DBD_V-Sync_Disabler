    ...
    while True:
        ...
        try:
            ...
            if command == "1":
                ...
                print(Fore.RED+"Invalid Command! Please enter a number!"+Fore.WHITE)
                time.sleep(2)
                os.system('cls')
                return disableVsync()

        except FileExistsError:
            print(Fore.RED+"An Unknown Error Occured!"+Fore.WHITE)
            time.sleep(2)
            os.system('cls')
            return disableVsync()

        try:
            print(Fore.GREEN+"Disabling your V-Sync..."+Fore.WHITE)
            time.sleep(2)
            ...
            # GameUserSettings.ini (Copy from Original Location)
            ...
            # Engine.ini (Copy from Original Location)
            ...
            # Finished
            print(Fore.GREEN+"V-Sync Disabled!"+Fore.WHITE)
            time.sleep(2)
            os.system('cls')
            return disableVsync()

        except FileNotFoundError:
            print(Fore.RED+"Config File Not Found!"+Fore.WHITE)
            time.sleep(2)
            os.system('cls')
            continue
...
def fixerror(): # Fix Config Error & Restore it to default
    ...
    print("Restoring your config files...")
    time.sleep(2)
    try:
    ...
    try:
        ...
        print(Fore.GREEN+"Config has been restored to default settings!"+Fore.WHITE)
        time.sleep(2)
        os.system('cls')

    except FileNotFoundError:
        print("Config Not Found! Please select valid platfrom!")
        os.system('cls')
        time.sleep(2)
        pass
